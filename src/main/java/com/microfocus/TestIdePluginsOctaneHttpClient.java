...
public class TestIdePluginsOctaneHttpClient implements OctaneHttpClient {

    private static final Logger logger = LoggerFactory.getLogger(TestIdePluginsOctaneHttpClient.class.getName());
    ...
    public TestIdePluginsOctaneHttpClient(String urlDomain, ClientType clientType) {
    ...
    private boolean grantTokenAuthenticate(Authentication authentication) {
        ...
        try {
            ...
            while (pollingTimeoutTimestamp > new Date().getTime()) {
                ...
                logger.debug("Poll response: " + pollResponseJson);
